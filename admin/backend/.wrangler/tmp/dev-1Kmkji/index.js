...
// .wrangler/tmp/bundle-FdOd5l/checked-fetch.js
...
// .wrangler/tmp/bundle-FdOd5l/strip-cf-connecting-ip-header.js
...
var getFileFromGitHub = /* @__PURE__ */ __name(async (env, path) => {
...
var updateFileOnGitHub = /* @__PURE__ */ __name(async (env, path, content, sha, message) => {
...
var addLog = /* @__PURE__ */ __name(async (env, action, details) => {
  try {
...
app.get("/api/logs", async (c) => {
  try {
    const month = c.req.query("month") || `${(/* @__PURE__ */ new Date()).getFullYear()}-${((/* @__PURE__ */ new Date()).getMonth() + 1).toString().padStart(2, "0")}`;
    const fileName = `logs/${month}.json`;
    try {
...
// .wrangler/tmp/bundle-FdOd5l/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-FdOd5l/middleware-loader.entry.ts
